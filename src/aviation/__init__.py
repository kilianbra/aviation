__all__ = ["required_global_fleet", "passengers_per_day", "average_flight_length"]
...
# This means we can now import the functions directly from the package namespace (thanks to the __all__)
...
# (this would have been required if we hadn't added the functions to the package namespace with the __all__)
